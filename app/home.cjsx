  ...
  render: ->
    <div className="home">
      ...
      <div className="home-content">
        ...
        <a className="learn-more-link" href="http://talk.chimpandsee.org/#/boards/BCP000000c/discussions/DCP0000lrf">We're collecting the best clips of 2015!<br />Nominate your favorites and vote today!</a>
