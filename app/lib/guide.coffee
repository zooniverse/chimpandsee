guideDetails = [{
...

  {
    ...
    subHeader: 'Syncerus caffer nanus'
  ...
  {
    header: 'hippopotamus'
    subHeader: 'Hippopotamus amphibius'
  ...
  {
    header: 'red duiker'
    subHeader: 'Sylvicapra and Cephalophus genuses'
...

  {
    ...
    subHeader: 'Potamochoerus porcus'
  ...
  {
    header: 'warthog'
    subHeader: 'Phacochoerus africanus'
